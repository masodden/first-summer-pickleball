export const ru = {
  ...
  'tournament.pointsToWinGroup': 'Счёт в группе',
  'tournament.pointsToWinPlayoff': 'Счёт в плей-офф',
  ...
  'tournament.startConfirmPairs':
    'Сформировать игры для {{count}} пар? Им придёт уведомление в Telegram.',
  'tournament.pairsCount': '{{count}} пар',
  'tournament.pairsCountOf': '{{count}} из {{max}} пар',
  ...
  'format.fixed_pairs': 'Фиксированные пары',
  ...
  'format.fixed_pairs.description':
    'Пары заявлены заранее и не меняются. Группы играют каждый с каждым, затем четверти, полуфиналы, финал и матчи за места.',

  'tie.draw': 'Разрешить ничью',
  'tie.golden_point': 'Доигрывать до победы',

  'participant.list': 'Участники',
  'participant.pairs': 'Пары',
  ...
  'participant.unpaired': 'Без пары',
  'partner.link': 'Связать пару',
  'partner.unlink': 'Отвязать',
  'partner.confirmJoin': 'Заявиться на турнир с игроком {{name}}?',
  'partner.confirmLink': 'Связать с игроком {{name}}?',
  'partner.confirmUnlink': 'Расформировать пару?',
  'partner.linked': 'Пара собрана',
  'partner.unlinked': 'Связка снята',
  'partner.locked': 'Пара зафиксирована оплатой',
  'partner.pick': 'Выбрать партнёра',
  'partner.needPairs': 'Соберите все пары, прежде чем стартовать',
  'partner.rosterMixed': '{{pairs}} · {{unpaired}} без пары',
  'bracket.title': 'Сетка',
  'bracket.intro':
    'Сначала круговой в группах. Дальше — четверти, полуфиналы, финал и матчи за места 5–12.',
  'bracket.groups': 'Число групп',
  'bracket.preset12': 'Пресет: 12 пар, 2 группы',
  'bracket.preset6': 'Пресет: 6 пар, 1 группа',
  'bracket.groupSection': 'Групповой этап',
  'bracket.groupWinsToTake': 'Геймов до победы',
  'bracket.groupWinsHint': '1 — один гейм, 2 — серия до двух побед',
  ...
  'bracket.playoffSection': 'После группы',
  'bracket.playoffHint':
    'Карточка — круг после группы. Счёт и число сетов у каждой стадии свои: полуфинал можно играть до 15, финал — серией до 11.',
  'bracket.stagePlayoff': 'Плей-офф',
  'bracket.stageConsolation': 'За места',
  'bracket.match': '{{name}} {{number}}',
  'bracket.vs': 'против',
  'bracket.sideA': 'Кто играет',
  'bracket.sideB': 'Против кого',
  'bracket.pickSource': 'Выберите',
  'bracket.groupPlaces': 'Места в группе',
  'bracket.previousResults': 'Кто уже сыграл',
  'bracket.groupPlace': '{{place}}-е место группы {{group}}',
  'bracket.groupPlaceSingle': '{{place}}-е место группы',
  'bracket.winnerOf': 'Победитель: {{match}}',
  'bracket.loserOf': 'Проигравший: {{match}}',
  'bracket.removeMatch': 'Удалить матч',
  'bracket.removeStage': 'Удалить стадию',
  'bracket.addStage': 'Добавить стадию',
  'bracket.addStageHint': 'Новый круг: финал, матч за 3-е, за 5-е.',
  'bracket.addSlot': 'Добавить матч в этот круг',
  'bracket.addSlotHint':
    'Вторая встреча в этом круге, если они идут параллельно. Сколько геймов до победы — поле «Побед в серии» выше.',
  'bracket.kind': 'Тип',
  'bracket.groupMatches': 'Кругов каждый-с-каждым',
  'bracket.stageName': 'Название',
  'bracket.stagePointsToWin': 'Счёт гейма',
  'bracket.preview': 'Как сыграют',
  'bracket.previewLine': '{{match}}: {{a}} — {{b}} ({{rules}})',
  'bracket.setsOne': '1 сет',
  'bracket.setsTo': 'до {{count}} побед',
  'bracket.gameRulesOne': '1 сет до {{points}}',
  'bracket.gameRulesSeries': 'до {{wins}} побед, сет до {{points}}',
  'bracket.sameRulesMany': 'Четверти, полуфиналы и места',
  'tournament.formatRules': 'Как играют',
  'bracket.issue.emptySources': 'У каждого матча должны быть выбраны обе пары',
  'bracket.issue.duplicateSources': 'Одно и то же место нельзя поставить в два матча',
  'bracket.issue.noFinal': 'Нужна финальная стадия — кто станет чемпионом',
  'bracket.issue.noThirdPlace': 'Нужен матч за 3-е место',
  'bracket.cannotStart': 'Сначала дособерите сетку: финал и матч за 3-е',
  'match.startMatch': 'Начать матч',
  'match.playersBusy': 'Эти игроки ещё на другом корте',
  'match.game': 'Гейм {{number}}',
  'match.series': 'Серия {{a}}:{{b}}',
  'standings.pair': 'Пара',
  ...
  'score.needPoints': 'Гейм играют до {{points}}',
  'score.needWinByTwo': 'Нужна победа с разницей в два очка',
  'score.seriesIncomplete': 'Доиграйте серию до победы',
