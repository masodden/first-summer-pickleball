export const ru = {
  ...
  'about.clubBody':
    'FIRST SUMMER PICKLEBALL развивает игру в Москве: чтобы было куда прийти, с кем сыграть и где провести дружеский турнир. Выбирай свою категорию и вперёд! Дальше научит сама игра =)',
