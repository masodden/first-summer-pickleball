export const ru = {
  ...
  'about.title': 'Об игре',
  'about.lead':
    'Пиклбол — это популярный вид спорта, сочетающий элементы тенниса, бадминтона и настольного тенниса. В него играют пластиковым мячом с дырками и специальными ракетками на площадке размером с бадминтонный корт. Сетка как в теннисе, только чуть ниже.',
  'about.lead2':
    'Можно играть одиночку и пару, в зале и на улице. Правила несложные: за один вечер можно разобраться и выйти на корт.',
  ...
  'about.scoreCall':
    'В одиночке счёт называют двумя числами: свои — чужие. В паре — тремя: свои — чужие — номер подающего (1 или 2). Игру начинают со счёта 0–0–2.',
  'about.singlesTitle': 'Одиночная игра',
  'about.singlesBody':
    'Если ваш счёт чётный — подаёте справа, если нечётный — слева. Проиграли розыгрыш — подача переходит к сопернику.',
  'about.doublesTitle': 'Парная игра',
  'about.doublesBody':
    'Партнёры меняются сторонами, только когда выиграли очко на своей подаче. Проиграли розыгрыш — подавать будут соперники.',
  ...
  'about.historyTitle': 'Откуда игра',
  'about.historyBody':
